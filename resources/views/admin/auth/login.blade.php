...
<head>
    ...
    <meta charset="utf-8" />
    <title>ZHTT College | Login</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta content="ZHTT College" name="description" />
    <meta content="Themesbrand" name="author" />
    <!-- App favicon -->
    <link rel="shortcut icon" href="{{ asset('frontend/images/img/logo/app-logo.png') }}">
                            ...
                            <div class="card-body p-4">
                                <div class="text-center mt-2">
                                    ...
                                    <div class="text-center mt-sm-1 mb-2 text-white-50">
                                        <div>
                                            <a href="#" class="d-inline-block auth-logo">
                                                <img src="{{ asset('frontend/images/img/logo/app-logo.png') }}" alt="" height="120">
                                            </a>
                                        </div>
                                    </div>
                                    <p class="text-muted">Sign in to continue to Z.H.T.T. College, Darbhanga</p>
                                ...
                                <div class="p-2 mt-4">
                                    <form action="{{ route('login') }}" method="POST">
                                        ...
                                        <div class="mt-4">
                                            <button class="btn btn-success w-100" type="submit" style="background-color:#3ea347;">Sign In</button>
                                        </div>
