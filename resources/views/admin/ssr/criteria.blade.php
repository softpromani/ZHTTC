@extends('admin.includes.layout', ['breadcrumb_title' => 'SSR Criteria'])
@section('title', 'SSR Criteria')
@section('main-content')
        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ isset($editcriteria) ? 'Update' : 'Add' }} SSR Criteria {{ $criteria_id }}</h4>
                </div><!-- end card header -->
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ isset($editcriteria) ? route('admin.ssrcriteria.update', $editcriteria->id) : route('admin.ssrcriteria.store') }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Manage SSR Criteria {{ $criteria_id }}</h4>
                </div><!-- end card header -->
                <div class="card-body">
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                    <li><a class="dropdown-item" href="{{ route('admin.ssrcriteria.edit', $cryptid) }}">Edit</a></li>
                                                ...
                                                <form id="delete-form-{{ $cryptid }}" action="{{ route('admin.ssrcriteria.destroy', $cryptid) }}"
