            ...
            <ul class="nav navbar-nav text-center">
                ...
                <li class="dropdown"><a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('co-curricular-activities') }}" target="_self">Co-curricular Acitivities</a></li>
                ...
                <li class="dropdown"> <a href="javascript:void(0)" class="dropdown-toggle" data-toggle="dropdown"
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="{{ route('college_development_committee') }}">College Development Committee</a></li>

                        <li><a href="{{ route('disciplinary_admission_committee') }}">Disciplinary/Admission Committee</a></li>

                        <li><a href="{{ route('grievance_antiragging_cell') }}">Grievance Redressal /Anti Ragging Cell</a></li>

                        <li><a href="{{ route('iqac') }}">Internal Quality Assurance Cell (IQAC)</a></li>

                        <li><a href="{{ route('advisory_committee') }}">Advisory Committee for Central Library</a></li>

                        <li><a href="{{ route('women_cell') }}">Women Cell/Anti Sexual Harassment Cell</a></li>

                        <li><a href="{{ route('steering_committee') }}">Steering Committee for NAAC of the College</a></li>
